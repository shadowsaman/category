...
func (r *CategoryRepo) GetByID(ctx context.Context, req *models.CategoryPrimeryKey) (*models.Category1, error) {
	...
	rows, err := r.db.Query(ctx, queryChild, resp.Id)
	if err != nil {
...
func (r *CategoryRepo) Update(ctx context.Context, category *models.UpdateCategory) error {
	...
	// fmt.Println(query, category.ParentId, category.Id)
